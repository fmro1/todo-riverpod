...
import 'package:todo_riverpod/repositories/providers/todos_repository_provider.dart';
...
class TodoList extends _$TodoList {
  ...
  Future<void> getTodos() async {
    ...
    try {
      ...
      state = state.copyWith(todos: todos, status: TodoListStatus.succes);
    } catch (e) {
  ...
  void editTodo(String id, String desc) async {
    ...
    try {
      ...
      state = state.copyWith(status: TodoListStatus.succes, todos: [
